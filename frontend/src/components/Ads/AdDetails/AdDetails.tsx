    ...
    <>
      ...
      <Center>
        <TopCard
          ...
          address={ad.address?.description || 'Not provided'}
      ...
      <DescriptionCard
        ...
        address_latitude={ad.address?.latitude || 0}
        address_longitude={ad.address?.longitude || 0}
        address_description={ad.address?.description || 'Not provided'}
